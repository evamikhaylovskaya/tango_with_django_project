...
def populate():
    ...
    # we want to add into each category. Then, we create a dictionary of dictionaries for our categories.
    ...
    # Iterate through the cats dictionary to add each category,
    # and then add all associated pages for that category.
